...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_BARACHIAN
    APT(SP_BARACHIAN,           SK_FIGHTING,        2),
    APT(SP_BARACHIAN,           SK_SHORT_BLADES,    1),
    APT(SP_BARACHIAN,           SK_LONG_BLADES,     2),
    APT(SP_BARACHIAN,           SK_AXES,            1),
    APT(SP_BARACHIAN,           SK_MACES_FLAILS,    1),
    APT(SP_BARACHIAN,           SK_POLEARMS,        0),
    APT(SP_BARACHIAN,           SK_STAVES,          1),
    APT(SP_BARACHIAN,           SK_SLINGS,          0),
    APT(SP_BARACHIAN,           SK_BOWS,            0),
    APT(SP_BARACHIAN,           SK_CROSSBOWS,       0),
    APT(SP_BARACHIAN,           SK_THROWING,        0),
    APT(SP_BARACHIAN,           SK_ARMOUR,          2),
    APT(SP_BARACHIAN,           SK_DODGING,         1),
    APT(SP_BARACHIAN,           SK_STEALTH,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_BARACHIAN,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_BARACHIAN,           SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_BARACHIAN,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_BARACHIAN,           SK_UNARMED_COMBAT,  1),
    APT(SP_BARACHIAN,           SK_SPELLCASTING,    0),
    APT(SP_BARACHIAN,           SK_CONJURATIONS,    1),
    APT(SP_BARACHIAN,           SK_HEXES,           1),
    APT(SP_BARACHIAN,           SK_CHARMS,          1),
    APT(SP_BARACHIAN,           SK_SUMMONINGS,      2),
    APT(SP_BARACHIAN,           SK_NECROMANCY,     -1),
    APT(SP_BARACHIAN,           SK_TRANSLOCATIONS,  1),
    APT(SP_BARACHIAN,           SK_TRANSMUTATIONS,  1),
    APT(SP_BARACHIAN,           SK_FIRE_MAGIC,      1),
    APT(SP_BARACHIAN,           SK_ICE_MAGIC,       2),
    APT(SP_BARACHIAN,           SK_AIR_MAGIC,       1),
    APT(SP_BARACHIAN,           SK_EARTH_MAGIC,     0),
